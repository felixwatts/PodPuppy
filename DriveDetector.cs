...
namespace Dolinay
{
    ...
    class DriveDetector : IDisposable 
    {
        ...
        public void WndProc(ref Message m)
        {
            ...
            if (m.Msg == W_DEVICECHANGE)
            {
                // W_DEVICECHANGE can have several meanings depending on the WParam value...
        ...
        private const int W_DEVICECHANGE = 0x0219;
        ...
        // Struct for parameters of the W_DEVICECHANGE message
        [StructLayout(LayoutKind.Sequential)]
